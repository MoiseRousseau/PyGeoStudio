"""
Create embankments programmatically
-----------------------------------
"""
...
# %%
# Define a function that create a simple embarnment given its base and creek length, its height and its XY location:
...
# %%
# Define a function that create multiple embankments one on the the top of the other:
def multiple_embankments(embankment_specs, covering, base_coordinate=(0,0)):
    """
...
# %%
# Use the two previous functions to create embankments in empty geometry in GeoStudio file.
src_file = "test.gsz" 
...
points, regions = multiple_embankments(specs, covering, base_coordinate)
...
geofile.saveAs("embankments.gsz")
